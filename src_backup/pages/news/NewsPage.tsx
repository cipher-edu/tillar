    ...
    return (
      <PageShell title={L(detail.title)}>
        ...
        <article className="max-w-4xl mx-auto">
          <img src={detail.cover} alt="" className="w-full h-64 md:h-96 object-cover rounded-[3rem] mb-10 shadow-2xl" />
          <p className="text-[11px] font-black uppercase tracking-widest text-amber-700 mb-6 font-ui">{detail.date}</p>
          <p className="text-2xl md:text-3xl italic font-serif-classic text-slate-700 leading-relaxed mb-12">
            {L(detail.body)}
          </p>
          {related.length > 0 && (
