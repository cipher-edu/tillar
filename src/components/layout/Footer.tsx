...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative overflow-hidden pt-16 sm:pt-24 md:pt-28 pb-8 sm:pb-12 bg-slate-950 safe-pb text-slate-100">
      ...
      />
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-[#eff7ff]0/10 blur-[150px] rounded-full pointer-events-none" />

      {/* Top border line */}
      <div className="absolute top-0 left-0 right-0 h-1 gov-gradient shadow-[0_0_20px_#1675e0]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid sm:grid-cols-2 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-10 mb-10 sm:mb-16">
          ...
          <div className="lg:col-span-4">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-14 h-14 gov-gradient rounded-2xl flex items-center justify-center shadow-lg border border-[#b6c6d7]/60">
              ...
              <div>
                ...
                <p className="text-[9px] tracking-[0.25em] uppercase text-[#1675e0] font-ui mt-1 flex items-center gap-1">
            ...
            <div className="flex flex-wrap gap-2.5">
              {contactInfo.socials.map((s) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-4 py-2 rounded-full border border-[#013d8c]/30 text-blue-200 text-[10px] font-black uppercase tracking-widest hover:gov-gradient hover:text-white transition-all font-ui bg-white/5 backdrop-blur-md"
                >
                  {s.label}
                </a>
              ))}
          ...
          <div className="lg:col-span-2">
            <h4 className="font-classic text-sm font-black mb-6 text-[#1675e0] tracking-widest uppercase border-b border-[#013d8c]/20 pb-3">
              {t('footer_quick')}
            </h4>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-4 text-slate-300 font-ui text-xs font-medium">
              <p className="flex items-start gap-3">
                <MapPin className="w-4 h-4 text-[#1675e0] shrink-0 mt-0.5" />
                <span className="leading-relaxed">{L(contactInfo.address)}</span>
              </p>
              <p className="flex items-center gap-3 font-semibold text-white">
                <Phone className="w-4 h-4 text-[#1675e0] shrink-0" />
                {contactInfo.phone}
              </p>
              <p className="flex items-center gap-3 font-semibold text-white">
                <Mail className="w-4 h-4 text-[#1675e0] shrink-0" />
                {contactInfo.email}
              </p>
            </div>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 mt-6 px-5 py-3 rounded-2xl bg-[#eff7ff]0/20 border border-[#1675e0]/40 text-blue-200 text-[10px] font-black uppercase tracking-widest font-ui hover:bg-[#1675e0] hover:text-slate-950 transition-all shadow-md"
            >
              {t('footer_uni')}
          ...
          <div className="lg:col-span-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl gov-gradient text-white text-[10px] font-black uppercase tracking-[0.2em] font-ui hover:scale-105 transition-all shadow-lg"
            >
        ...
        <div className="mb-12 rounded-[2.5rem] overflow-hidden border border-[#013d8c]/30 shadow-2xl bg-slate-900">
        ...
        <div className="border-t border-white/10 pt-8 space-y-6">
          <div className="relative rounded-[2rem] border border-[#013d8c]/30 bg-slate-900/80 backdrop-blur-xl px-6 py-5 md:px-8 md:py-6 shadow-2xl overflow-hidden flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="absolute left-0 top-0 bottom-0 w-1.5 gov-gradient" />
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.35em] text-[#1675e0] font-ui mb-1">
                {t('footer_dev_label')}
              </p>
            ...
            <div className="flex items-center gap-3 shrink-0">
              <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#eff7ff]0/20 border border-[#1675e0]/30 text-blue-200 text-[10px] font-black uppercase tracking-[0.2em] font-ui">
                <span className="w-2 h-2 rounded-full bg-[#1675e0] animate-ping" />
                {t('footer_dev_badge')}
              </div>
              <button
                onClick={scrollToTop}
                className="w-11 h-11 rounded-full border border-[#1675e0]/40 bg-white/10 hover:gov-gradient hover:text-white text-[#1675e0] flex items-center justify-center transition-all duration-300"
