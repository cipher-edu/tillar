...
export const PageShell: React.FC<PageShellProps> = ({
  ...
  return (
    <section
      className={`relative overflow-hidden min-h-screen pt-40 pb-24 ${
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex justify-center mb-4">
          <ShamsaMedallion className="w-10 h-10 shadow-lg rounded-full" />
        </div>
        ...
        <div className="text-center mb-16">
          <motion.h1
            ...
            className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-classic uppercase tracking-widest leading-tight ${
          ...
          {subtitle && (
            <motion.p
              ...
              className={`mt-6 text-xl md:text-2xl lg:text-3xl italic font-serif-classic max-w-4xl mx-auto leading-relaxed ${
